...
import mnist_loader  # Importing the mnist_loader module to load MNIST data
training_data, validation_data, test_data = mnist_loader.load_data_wrapper()  # Load the MNIST dataset
import random
import numpy as np
